...
for (const script of ['ci:contracts', 'ci:golden', 'security:audit-dependencies', 'test:teaching-assets', 'test:authoring-boundary', 'test:repository-ownership', 'test:live-golden-path-contract', 'audit:command-surface']) {
