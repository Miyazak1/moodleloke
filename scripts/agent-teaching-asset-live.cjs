...
function assertLocalDatabase() {
  assert(process.env.NODE_ENV !== 'production' && process.env.MOODLELIKE_ENV !== 'production' && process.env.CSC_ENV !== 'production', 'TeachingAsset live rehearsal is disabled in production.');
