...
- `npm run local:acceptance`: run runtime verification, the zero-Provider real-browser read gate, dependency security audit, complete core contracts and all three deterministic browser golden paths.
