...
const AUTH_COPY = {
  zh: {
    ...
    body: '登录后可以保存模考记录、科目练习、错题复盘、AI 反馈额度和咨询入口。',
    tabAria: '账号模式',
    login: '登录',
    register: '注册',
    google: '使用 Google 登录',
  ...
  en: {
    ...
    body: 'After logging in, you can save mock reports, subject practice, mistake review, target schools, and consulting entry points.',
  ...
  vi: {
    ...
    body: 'Sau khi đăng nhập, bạn có thể lưu báo cáo thi thử, luyện theo môn, ôn câu sai, trường mục tiêu và lối vào tư vấn.',
